...
clear;clear;clear
  ...
  # // Banner
echo -e "${lolcat}--------------------WELLCOME TO SCRIPT--------------------${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " ____  ___________        ______ _____ "
echo -e "|  _ \|___ /___ \ \      / /  _ \_   _|_  __ "
echo -e "| |_) | |_ \ __) \ \ /\ / /| |_) || | \ \/ / "
echo -e "|  _ < ___) / __/ \ V  V / |  _ < | |  >  < "
echo -e "|_| \_\____/_____| \_/\_/  |_| \_\|_| /_/\_\ "
echo -e " _____ _   _ _   _ _   _ _____ _     ___ _   _  ____ "
echo -e "|_   _| | | | \ | | \ | | ____| |   |_ _| \ | |/ ___| "
echo -e "  | | | | | |  \| |  \| |  _| | |    | ||  \| | |  _ "
echo -e "  | | | |_| | |\  | |\  | |___| |___ | || |\  | |_| | "
echo -e "  |_|  \___/|_| \_|_| \_|_____|_____|___|_| \_|\____| "
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Developer > R32WRTx TUNNELING ${YELLOW}(${NC}${green} Stable Edition V3.09 ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}R32WRTx TUNNELING ® ${NC}${YELLOW}(${NC} ${green} R32WRTx TUNNELING ${NC}${YELLOW})${NC}"
echo -e " © Recode By R32WRTx TUNNELING ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/rwrtx/scvvip/main/"
...
function print_success() {
    if [[ 0 -eq $? ]]; then
		echo -e "${green} =============================== ${FONT}"
		echo -e "${Green} # Script By : R32WRTx TUNNELING"
        echo -e "${NS} ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ ${FONT}" | lolcat
...
wget raw.githubusercontent.com/rwrtx/scvvip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
...
echo -e "  |_|  \___/|_| \_|_| \_|_____|_____|___|_| \_|\____| "
echo -e "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" | lolcat
echo -e "${green} Script By : R32WRTx TUNNELING Telah Sukses DiInstall"
echo ""
echo -e "${cyan} Selamat Menikmati Fasilitas Yang Ada"
echo -e "${cyan} Jangan Lupa Berbagi Sesama Manusia"
echo -e "${cyan} Semoga Dilancarkan Rezekinya Oleh Tuhan Yang Maha Esa"
echo ""
